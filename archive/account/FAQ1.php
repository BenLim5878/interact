        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    <a id="current-link" href="FAQ1.php">How to update/edit my profile?</a>
                    <a href="FAQ2.php">How to delete my account?</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">How to update/edit my profile?</h1>
