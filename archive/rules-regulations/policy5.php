        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    ...
                    <a href="policy3.php">Is posting someone's private or personal information okay?</a>
                    <a href="policy4.php">Legal Restrictions on Content</a>
                    <a id="current-link" href="policy5.php">Pornography and sex-related content restriction</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">Pornography and sex-related content restriction</h1>
