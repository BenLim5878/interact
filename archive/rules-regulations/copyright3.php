        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    <a href="copyright1.php">Copyright at Interact</a>
                    <a href="copyright2.php">What types of works does copyright protect?</a>
                    <a id="current-link" href="copyright3.php">How to report an unauthorized copy of work on Interact?</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">How to report an unauthorized copy of work on Interact?</h1>
                        <h4 class="data-posted">
<?php
// Variables
$category = "Copyright Help Center";
$ID = "20";
$data = 'datePosted';
