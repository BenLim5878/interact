        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    ...
                    <a id="current-link" href="copyright2.php">What types of works does copyright protect?</a>
                    <a href="copyright3.php">How to report an unauthorized copy of work on Interact?</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">What types of works does copyright protect?</h1>
