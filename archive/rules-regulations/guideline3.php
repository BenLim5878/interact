        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    <a href="guideline1.php">Posting & Commenting</a>
                    <a href="guideline2.php">Promotion</a>
                    <a id="current-link" href="guideline3.php">Be Nice, Be Respectful</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">Be Nice, Be Respectful</h1>
