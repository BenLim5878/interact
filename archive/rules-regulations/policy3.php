...
<body onload="textArea()">
    <div class="wrapper">
        ...
        <div id="pathway-links">
            ...
            <a href="/interact/rules.php" id="rules-back">Rules & Regulations</a>
        </div>
        <div class="seperator">
            <div class="side-menu">
                <h5>Articles in this section</h5>
                <div class="side-menu-links">
                    <a href="policy1.php">What are the rules?</a>
                    <a href="policy2.php">Restriction on violent content</a>
                    <a id="current-link" href="policy3.php">Is posting someone's private or personal information okay?</a>
                    <a href="policy4.php">Legal Restrictions on Content</a>
                    <a href="policy5.php">Pornography and sex-related content restriction</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">Is posting someone's private or personal information okay?</h1>
