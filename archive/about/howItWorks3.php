        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    <a href="howItWorks1.php">Getting Started with Interact</a>
                    <a href="howItWorks2.php">Access to APSpace</a>
                    <a id="current-link" href="howItWorks3.php">What can I do with Interact?</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">What can I do with Interact</h1>
