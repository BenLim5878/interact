        ...
        <div class="seperator">
            <div class="side-menu">
                ...
                <div class="side-menu-links">
                    ...
                    <a id="current-link" href="safeInteract2.php">What’s our privacy policy?</a>
                    <a href="safeInteract3.php">How do I make complaint?</a>
                    <a href="safeInteract4.php">I may be the victim of a fraud or scam</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">What’s our privacy policy?</h1>
