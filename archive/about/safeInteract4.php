...
<body onload="textArea()">
    <div class="wrapper">
        ...
        <div id="pathway-links">
            ...
            <a href="/about.php" id="rules-back">About</a>
        </div>
        <div class="seperator">
            <div class="side-menu">
                <h5>Articles in this section</h5>
                <div class="side-menu-links">
                    <a href="safeInteract1.php">Is Interact Safe?</a>
                    <a href="safeInteract2.php">What’s our privacy policy?</a>
                    <a href="safeInteract3.php">How do I make complaint?</a>
                    <a id="current-link" href="safeInteract4.php">I may be the victim of a fraud or scam</a>
                </div>
            </div>
            <div class="inner-wrapper">
                ...
                <div class="help-contentsBox">
                    <div class="main-header">
                        <h1 class="title">I may be the victim of a fraud or scam</h1>
                        <h4 class="data-posted">
                            <?php
                            // Variables
                            $category = "safeInteract";
                            $ID = "33";
                            $data = 'datePosted';
